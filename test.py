...
def KNN():
    ...
    print(img.blue, img.green, img.red)
...
class Example(QWidget):
    ...
    def __init__(self):
        ...
        self.button_Kmeans = QPushButton('K means', self)
    ...
    def initUI(self):
        ...
        grid.addWidget(self.button_camera, 2, 0, 5, 1)
        grid.addWidget(self.button_Kmeans, 3, 0, 5, 1)
        grid.addWidget(self.button_KNN, 4, 0, 5, 1)
        grid.addWidget(QLabel('Predict:'), 5, 0, 5, 1)
        grid.addWidget(self.label_Image, 1, 1, 10, 20)
        ...
        self.button_KNN.clicked.connect(KNN)
        # Click algorithms Kmeans.
        self.button_Kmeans.clicked.connect(self.Kmeans)
        self.setLayout(grid)
    ...
    def get_image_file(self):
        ...
        print("Path file image: ", imagePath)
